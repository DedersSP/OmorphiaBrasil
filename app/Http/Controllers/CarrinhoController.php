...
class CarrinhoController extends Controller
{
    ...
    public function adicionar()
    {
        ...
        if($idcliente = $req->input('cliente_id')){
        ...
        if( empty($idpedido) ) {
            $pedido_novo = Pedido::create($dados);
    ...
    public function concluir()
    {
        ...
        $status_pg = $req->input('status_pg');
        $meio_pg = $req->input('meio_pg');
        $comprovante = $req->input('comprovante');
        $status_entrega = $req->input('status_entrega');
        $data_entrega = $req->input('data_entrega');
        if(empty($data_entrega)){
            $data_formatada = null;
        }else{
            $data_formatada = \DateTime::createFromFormat('Y-m-d', $data_entrega);
        }
        
        $recebedor = $req->input('recebedor');
        $obs = $req->input('obs');
    ...
    public function vendas()
    {
        ...
        return view('carrinho.vendas', compact('vendas'));
    }
}
